...
const ModalProfil = ({ isVisible, onClose }) => {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="overflow-y-scroll sm:w-3/5 sm:h-5/6 pt-24 sm:pt-12 h-screen text-wrap z-20 space-y-2 dark:text-zinc-300 bg-zinc-100 dark:bg-neutral-950 text-zinc-950 absolute sm:bottom-0 sm:right-0 p-8"
