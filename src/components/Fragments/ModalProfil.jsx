...
const ModalProfil = ({ isVisible, onClose }) => {
  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.div
          className="overflow-y-auto sm:w-3/5 sm:h-5/6 h-full text-wrap :top-0 z-50 space-y-2 dark:text-black bg-zinc-950 dark:bg-zinc-100 text-zinc-300 absolute sm:bottom-0 sm:right-0 p-8"
        ...
        >
          <div className="flex group relative justify-center max-w-screen-sm items-center">
            <img
              ...
              alt="example"
            />
            <div className=" absolute text-sm font-medium top-5 flex justify-between w-full tracking-wider px-4 text-md group-hover:text-zinc-200 delay-200 duration-500 ease-in-out drop-shadow text-red-500">
              <h1>name? </h1>
              <h1>my name's</h1>
            </div>
            <div className="text-4xl flex justify-center w-full absolute group-hover:text-zinc-200 delay-200 duration-500 ease-in-out drop-shadow text-red-500 font-bold">
              <Typewriter
                options={{
            ...
            <div className=" absolute font-medium bottom-5 text-sm flex justify-between w-full tracking-wider px-4 text-md group-hover:text-zinc-200 delay-200 duration-500 ease-in-out drop-shadow text-red-500">
